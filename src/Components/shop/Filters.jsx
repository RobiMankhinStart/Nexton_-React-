...
const Filters = ({ openfilter, setOpenfilter }) => {
  ...
  return (
    <section
      className={`${
        openfilter ? "md:left-0" : "-left-[700px]"
      } h-[500px] overflow-y-scroll z-10 top-52 fixed p-3 duration-300 transition-all lg:bg-transparent  bg-gray-100 rounded-lg inline-block lg:hidden `}
    >
